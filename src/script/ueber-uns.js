...
window.addEventListener("scroll", ()=>{
    let topA=document.getElementById("topU").offsetTop;
    let nav=document.querySelector(".nav-desktop");
    let topC= document.getElementById("welcome-ue").offsetHeight;
 ...
 window.addEventListener("scroll",()=>{
   let a=document.getElementById("topU").offsetTop;
   let topC= document.getElementById("welcome-ue").offsetHeight;
   if(window.scrollY>=a){
...
let ss = document.getElementById('ueber-uns');
